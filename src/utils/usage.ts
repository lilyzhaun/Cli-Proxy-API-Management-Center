...
const DEFAULT_MODEL_PRICES: Record<string, ModelPrice> = {
  ...
  'claude-sonnet-4-6': { prompt: 3, completion: 15, cache: 0.3 },
  'claude-opus-4-6-thinking': { prompt: 5, completion: 25, cache: 0.5 },
  'claude-3-5-sonnet-20241022': { prompt: 3, completion: 15, cache: 0.3 },
  'gemini-2.5-flash': { prompt: 0.3, completion: 2.5, cache: 0.3 },
  'gemini-2.5-flash-thinking': { prompt: 0.3, completion: 2.5, cache: 0.3 },
  'gemini-2.5-flash-lite': { prompt: 0.1, completion: 0.4, cache: 0.1 },
  'gemini-2.5-pro': { prompt: 1.25, completion: 10, cache: 1.25 },
  'gemini-3-flash-preview': { prompt: 0.5, completion: 3, cache: 0.5 },
  'gemini-3.1-pro-preview': { prompt: 2, completion: 12, cache: 2 },
  'gemini-3-pro-preview': { prompt: 2, completion: 12, cache: 2 },
  'moonshotai/kimi-k2:free': { prompt: 0, completion: 0, cache: 0 },
};
